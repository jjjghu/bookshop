...
(32, 2, 3, 66, '2024-06-08 23:15:53'),
(33, 2, 4, 49, '2024-06-08 23:20:21'),
(34, 2, 7, 7, '2024-06-08 23:20:22'),
(35, 2, 8, 1, '2024-06-08 23:20:22'),
(36, 2, 9, 1, '2024-06-08 23:20:23'),
(37, 2, 2, 1, '2024-06-08 23:26:49');
...
(63, 7, 'ㄇ', 'jjjghu', 2, '2024-06-08 11:39:55'),
(64, 7, 'a', 'jjjghu', 2, '2024-06-08 11:39:56');
...
--
ALTER TABLE `cart`
  ADD CONSTRAINT `cart_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `author` (`id`),
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `author` (`id`);
